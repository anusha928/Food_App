...
class AppColors {
  ...
  static final Color lilblackColor = Color.fromARGB(255, 89, 89, 85);
  static final Color icon1color = const Color(0xFFffd28d);
  static final Color icon3color = const Color(0xFFfcab88);
